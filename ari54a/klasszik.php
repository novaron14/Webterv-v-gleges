...
?>
    ...
    <section id="description">
        <div class="container">
            <img src="img/logo_klasszik.png" alt="Turul Energiaital Klasszik">
            <div class="wrapper">
                <article>
                    <h1>Amit senkinek sem kell bemutatni...</h1>
                    <p>
                        Ragadj magadhoz egyet a Föld legmagyarabb energiafőzetéből! Vigyázat! A Turul rendszeres
                        fogyasztásának súlyos következményei lehetnek, ezek közül néhány:
                    </p>
                        <ul style="text-indent: 20px">
                            <li>150% hazafiság</li>
                            <li>Az elhallgatott magyarságtörténet teljes ismerete</li>
                            <li>Hazaárulók kiszűrése ránézésre</li>
                            <li>Minimum 5 gyerek szülése</li>
                        </ul>
                </article>
