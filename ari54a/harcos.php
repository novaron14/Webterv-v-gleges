...
?>
    ...
    <section id="description">
        <div class="container">
            <img src="img/logo_harcos.png" alt="Turul Energiaital Harcos">
            <img id="uj" src="img/uj.png" alt="Új termék">
            <div class="wrapper">
                <article>
                    <h1>Extra adag koffein - a nehéz időkre...</h1>
                    <p>
                        Az emberek évek óta bombáznak minket emailekkel, hogy legyen végre egy Turul még több koffeinnel. Hát most megvan, haver!
                        A Turul Harcos segít legyőzni a kimerültséget, fokozza az éberséget, és felpörget, hogy jobban menjen a munka - szóval, hogy összességében rohadt jól érezd magad!
                        Mellékhatás: fékezhetetlen vágy Felvidék azonnali visszafoglalására.
                    </p>
                </article>
    ...
    <section id="general-stuff">
        <div class="container">
            ...
            <p>
                Magas koffeintartalmú. A termék fogyasztása gyermekeknek, terhes nőknek és szoptató anyáknak, koffeinérzékenyeknek, szív- és érrendszeri betegségekben, magas vérnyomásban szenvedőknek nem ajánlott (40 mg/100 ml). Fogyasztása alkohollal nem ajánlott. Fogyaszd felelősséggel!
